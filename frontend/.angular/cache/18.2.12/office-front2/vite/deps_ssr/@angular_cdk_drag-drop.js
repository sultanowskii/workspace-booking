...
var DragRef = class {
  ...
  constructor(element, _config, _document, _ngZone, _viewportRuler, _dragDropRegistry) {
    ...
    this._moveEvents = new import_rxjs3.Subject();
    this._pointerMoveSubscription = import_rxjs3.Subscription.EMPTY;
    this._pointerUpSubscription = import_rxjs3.Subscription.EMPTY;
    this._scrollSubscription = import_rxjs3.Subscription.EMPTY;
    ...
    this.beforeStarted = new import_rxjs3.Subject();
    this.started = new import_rxjs3.Subject();
    this.released = new import_rxjs3.Subject();
    this.ended = new import_rxjs3.Subject();
    this.entered = new import_rxjs3.Subject();
    this.exited = new import_rxjs3.Subject();
    this.dropped = new import_rxjs3.Subject();
...
var DropListRef = class {
  constructor(element, _dragDropRegistry, _document, _ngZone, _viewportRuler) {
    ...
    this.exited = new import_rxjs3.Subject();
    this.dropped = new import_rxjs3.Subject();
    this.sorted = new import_rxjs3.Subject();
    this.receivingStarted = new import_rxjs3.Subject();
    this.receivingStopped = new import_rxjs3.Subject();
    this._isDragging = false;
    this._draggables = [];
    this._siblings = [];
    this._activeSiblings = /* @__PURE__ */ new Set();
    this._viewportScrollSubscription = import_rxjs3.Subscription.EMPTY;
    this._verticalScrollDirection = AutoScrollVerticalDirection.NONE;
    this._horizontalScrollDirection = AutoScrollHorizontalDirection.NONE;
    this._stopScrollTimers = new import_rxjs3.Subject();
    this._cachedShadowRoot = null;
    this._scrollableElements = [];
    this._direction = "ltr";
    this._startScrollInterval = () => {
      this._stopScrolling();
      (0, import_rxjs3.interval)(0, import_rxjs3.animationFrameScheduler).pipe((0, import_operators2.takeUntil)(this._stopScrollTimers)).subscribe(() => {
...
var DragDropRegistry = class _DragDropRegistry {
  constructor(_ngZone, _document) {
    ...
    this.pointerMove = new import_rxjs3.Subject();
    this.pointerUp = new import_rxjs3.Subject();
    this.scroll = new import_rxjs3.Subject();
  ...
  scrolled(shadowRoot) {
    ...
    if (shadowRoot && shadowRoot !== this._document) {
      streams.push(new import_rxjs3.Observable((observer) => {
        return this._ngZone.runOutsideAngular(() => {
    ...
    return (0, import_rxjs3.merge)(...streams);
  }
  ngOnDestroy() {
...
var CdkDrag = class _CdkDrag {
  ...
  constructor(element, dropContainer, _document, _ngZone, _viewContainerRef, config, _dir, dragDrop, _changeDetectorRef, _selfHandle, _parentDrag) {
    ...
    this._handles = new import_rxjs3.BehaviorSubject([]);
    this.scale = 1;
    ...
    this.moved = new import_rxjs3.Observable((observer) => {
  ...
  _setupHandlesListener() {
    this._handles.pipe(
      ...
      (0, import_operators2.switchMap)((handles) => {
        return (0, import_rxjs3.merge)(...handles.map((item) => item._stateChanges.pipe((0, import_operators2.startWith)(item))));
      }),
...
var CdkDropList = class _CdkDropList {
  ...
  _handleEvents(ref) {
    ...
    (0, import_rxjs3.merge)(ref.receivingStarted, ref.receivingStopped).subscribe(() => this._changeDetectorRef.markForCheck());
  }
  /** Assigns the default input values based on a provided config object. */
  _assignDefaults(config) {
    const {
