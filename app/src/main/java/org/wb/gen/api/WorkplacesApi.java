...
public interface WorkplacesApi {
     ...
     */
    @Operation(operationId = "createWorkplace", summary = "Create workplace", responses = {
            @ApiResponse(responseCode = "201", description = "Success", content = {
                    @Content(mediaType = "application/json", schema = @Schema(implementation = Workplace.class))
            })
    })
    @RequestMapping(method = RequestMethod.POST, value = "/workplaces", produces = { "application/json" }, consumes = {
            "application/json" })
     ...
     */
    @Operation(operationId = "deleteWorkplace", summary = "Delete workplace", responses = {
            @ApiResponse(responseCode = "201", description = "Success"),
            @ApiResponse(responseCode = "404", description = "Resource Not Found", content = {
                    @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class))
            })
    })
    @RequestMapping(method = RequestMethod.DELETE, value = "/workplaces/{id}", produces = { "application/json" })
     ...
     *         or Resource Not Found (status code 404)
     */
    @Operation(operationId = "getWorkplace", summary = "Get workplace", responses = {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/workplaces/{id}", produces = { "application/json" })
     ...
     * Get list of workplaces. Supported sort/search fields:
     * &#x60;numberOfMonitors&#x60;
     *
     ...
     * @return Success (status code 200)
     */
    @Operation(operationId = "getWorkplaces", summary = "Get workplaces", description = "Get list of workplaces. Supported sort/search fields: `numberOfMonitors` ", responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                    @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = Workplace.class)))
            })
    })
    @RequestMapping(method = RequestMethod.GET, value = "/workplaces", produces = { "application/json" })
     ...
     *         or Resource Not Found (status code 404)
     */
    @Operation(operationId = "updateWorkplace", summary = "Update workplace", responses = {
            @ApiResponse(responseCode = "200", description = "Success", content = {
                    @Content(mediaType = "application/json", schema = @Schema(implementation = Workplace.class))
            }),
            @ApiResponse(responseCode = "404", description = "Resource Not Found", content = {
    ...
    @RequestMapping(method = RequestMethod.PUT, value = "/workplaces/{id}", produces = {
